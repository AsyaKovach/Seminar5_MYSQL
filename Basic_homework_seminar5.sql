...
-- Task2 Изменить в существующем представлении порог для стоимости: пусть цена будет до 30 000 долларов (используя оператор OR REPLACE) 
CREATE OR REPLACE VIEW lowcost_cars AS 
SELECT model, cost AS "Машины до $30000"
FROM cars
WHERE cost < 30000;
